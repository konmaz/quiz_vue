  ...
  <div class="container">
    <div class="card mx-auto shadow-lg mt-3" style="width: 20em">
      ...
      <div class="card-body text-center">
        <input type="text" placeholder="Please fill your Name first" v-model="userName" class="form-control" autofocus>
        ...
        <div class="row">
          <div class="col">
            <input type="text"
                   ...
                   class="form-control rounded-pill text-bg-warning text-md-center fw-semibold font-monospace"

            >
          </div>
          <div class="col">
            <button class="btn btn-primary" :disabled="nameIsEmpty || roomCodeIsEmpty" @click="joinGame"><span class="text-warning">Join</span> a Room</button>
          </div>
        </div>
